...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background relative">
      ...
      <Sidebar isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} isDrawer={true} />

      <main className="flex-1 w-full relative overflow-hidden bg-gradient-to-b from-brand-50/50 to-background py-16 md:py-24">
