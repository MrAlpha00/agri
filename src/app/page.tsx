  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      <div className="text-center mb-16 relative">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-500/10 border border-brand-500/20 text-brand-600 text-sm font-medium mb-6">
          <Leaf className="w-4 h-4" />
          <span>AI-Powered Agriculture</span>
        </div>

        <h1 className="text-5xl font-bold tracking-tight mb-6 text-slate-900">
          Detect Crop Diseases in <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-emerald-600">Seconds</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
        {[
          ...
          <div key={i} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col items-start gap-4 hover:border-brand-500/30 hover:shadow-md transition-all">
